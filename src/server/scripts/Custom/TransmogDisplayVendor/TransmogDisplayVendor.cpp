	...
	else
	{
		...
		if (item_data->tworating >= 0 || item_data->threerating >= 0)
		{
			...
			if (twohighest < item_data->tworating && threehighest < item_data->threerating)
			{
				...
				else if (item_data->tworating > 0 && item_data->threerating > 0)
				...
				ChatHandler(player->GetSession()).PSendSysMessage("2 rating: %u, 3 rating: %u", item_data->tworating, item_data->threerating);
