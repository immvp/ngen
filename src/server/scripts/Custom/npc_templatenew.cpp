/*
Done:
+ Glyph System Fully (All Classes!)
+ Talents System :
Case 1 Talents Done Warrior - Arms
Case 3 Talents Done Warrior - Protection
Case 4 Talents Done Paladin - Holy
Case 5 Talents Done Paladin - Protection
Case 6 Talents Done Paladin - Retribution
...
enum glyphs
{
    ...
    MINOR_WARLOCK_GLYPH_OF_CURSE_OF_EXHAUSION = 480,
...
public:
    ...
    void SocketSlot(Player* player, Item* item, uint32 gemid, uint32 socketslot)
    {
        ...
        I (Lightning Blade) implemented the uin32 socketslot argument, which basically determents
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        if (!player->IsInCombat())
        {
            ...
            {
            case CLASS_WARRIOR:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Arms", GOSSIP_SENDER_MAIN, 1);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Fury", GOSSIP_SENDER_MAIN, 2);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Protection", GOSSIP_SENDER_MAIN, 3);
                break;
            case CLASS_PALADIN:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Holy", GOSSIP_SENDER_MAIN, 4);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Protection", GOSSIP_SENDER_MAIN, 5);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Retribution", GOSSIP_SENDER_MAIN, 6);
                break;
            case CLASS_HUNTER:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Beastmastery", GOSSIP_SENDER_MAIN, 7);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Marksmanship", GOSSIP_SENDER_MAIN, 8);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Survival", GOSSIP_SENDER_MAIN, 9);
                break;
            case CLASS_ROGUE:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Assassination", GOSSIP_SENDER_MAIN, 10);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Combat", GOSSIP_SENDER_MAIN, 11);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Sublety", GOSSIP_SENDER_MAIN, 12);
                break;
            case CLASS_PRIEST:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Discipline", GOSSIP_SENDER_MAIN, 13);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Holy", GOSSIP_SENDER_MAIN, 14);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Shadow", GOSSIP_SENDER_MAIN, 15);
                break;
            case CLASS_DEATH_KNIGHT:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Blood", GOSSIP_SENDER_MAIN, 16);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Frost", GOSSIP_SENDER_MAIN, 17);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Unholy", GOSSIP_SENDER_MAIN, 18);
                break;
            case CLASS_SHAMAN:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Elemental", GOSSIP_SENDER_MAIN, 19);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Enhancement", GOSSIP_SENDER_MAIN, 20);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Restoration", GOSSIP_SENDER_MAIN, 21);
                break;
            case CLASS_MAGE:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Arcane", GOSSIP_SENDER_MAIN, 22);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Fire", GOSSIP_SENDER_MAIN, 23);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Frost", GOSSIP_SENDER_MAIN, 24);
                break;
            case CLASS_WARLOCK:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Affliction", GOSSIP_SENDER_MAIN, 25);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Demonology", GOSSIP_SENDER_MAIN, 26);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Destruction", GOSSIP_SENDER_MAIN, 27);
                break;
            case CLASS_DRUID:
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Balance", GOSSIP_SENDER_MAIN, 28);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Feral", GOSSIP_SENDER_MAIN, 29);
                player->ADD_GOSSIP_ITEM(GOLD_DOT_ICON, "|cff800517 Restoration", GOSSIP_SENDER_MAIN, 30);
                break;
            }
...
#pragma endregion Destroying Current Equipped items
        ...
        {
        case 1:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_NECK, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_SHOULDERS, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_CHEST, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_BODY, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_WAIST, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_LEGS, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_WRISTS, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_HANDS, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_FINGER1, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_FINGER2, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_TRINKET1, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_TRINKET2, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_BACK, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_MAINHAND, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_OFFHAND, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_RANGED, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_TABARD, 0, true);
            player->EquipNewItem(EQUIPMENT_SLOT_FEET, 0, true);

            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_HEAD), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_NECK), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_SHOULDERS), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_CHEST), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_BODY), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_WAIST), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_LEGS), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_WRISTS), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_HANDS), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_FINGER1), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_FINGER2), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_TRINKET1), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_TRINKET2), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_BACK), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_MAINHAND), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_OFFHAND), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_RANGED), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_TABARD), 0);
            Enchant(player, player->GetItemByPos(EQUIPMENT_SLOT_FEET), 0);

            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_HEAD), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_NECK), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_SHOULDERS), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_CHEST), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_BODY), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_WAIST), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_LEGS), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_WRISTS), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_HANDS), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_FINGER1), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_FINGER2), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_TRINKET1), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_TRINKET2), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_BACK), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_MAINHAND), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_OFFHAND), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_RANGED), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_TABARD), 0, 0);
            SocketSlot(player, player->GetItemByPos(EQUIPMENT_SLOT_FEET), 0, 0);


            player->ResetTalents();
            player->LearnTalent(12286, 2);
            player->LearnTalent(16462, 3);
            player->LearnTalent(12295, 3);
            player->LearnTalent(12300, 3);
            player->LearnTalent(16493, 2);
            player->LearnTalent(12834, 3);
            player->LearnTalent(12290, 2);
            player->LearnTalent(56636, 3);
            player->LearnTalent(12163, 3);
            player->LearnTalent(12328, 1);
            player->LearnTalent(12700, 5);
            player->LearnTalent(46854, 2);
            player->LearnTalent(20504, 2);
            player->LearnTalent(12294, 1);
            player->LearnTalent(46865, 2);
            player->LearnTalent(29834, 2);
            player->LearnTalent(35446, 3);
            player->LearnTalent(46859, 2);
            player->LearnTalent(64976, 1);
            player->LearnTalent(29836, 2);
            player->LearnTalent(29623, 1);
            player->LearnTalent(29723, 3);
            player->LearnTalent(46867, 5);
            player->LearnTalent(46924, 1);
            player->LearnTalent(12320, 5);
            player->LearnTalent(12321, 2);
            player->LearnTalent(61216, 3);
            player->LearnTalent(16487, 3);
            player->LearnTalent(12323, 1);
            // Arms Warrior
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_WARRIOR_GLYPH_OF_MORTAL_STRIKE);
            //Minor
            player->SetGlyph(1, MINOR_WARRIOR_GLYPH_OF_BATTLE);
            //Minor
            player->SetGlyph(2, MINOR_WARRIOR_GLYPH_OF_BLOODRAGE);
            //Major
            player->SetGlyph(3, MAJOR_WARRIOR_GLYPH_OF_RENDING);
            //Minor
            player->SetGlyph(4, MINOR_WARRIOR_GLYPH_OF_CHARGE);
            //Major
            player->SetGlyph(5, MAJOR_WARRIOR_GLYPH_OF_EXECUTION);
        ...
        case 2:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_WARRIOR_GLYPH_OF_WHIRLWIND);
            //Minor
            player->SetGlyph(1, MINOR_WARRIOR_GLYPH_OF_BATTLE);
            //Minor
            player->SetGlyph(2, MINOR_WARRIOR_GLYPH_OF_BLOODRAGE);
            //Major
            player->SetGlyph(3, MAJOR_WARRIOR_GLYPH_OF_HEROIC_STRIKE);
            //Minor
            player->SetGlyph(4, MINOR_WARRIOR_GLYPH_OF_CHARGE);
            //Major
            player->SetGlyph(5, MAJOR_WARRIOR_GLYPH_OF_BLOODTHIRST);
            player->SendTalentsInfoData(false);
            break;
        case 3:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->ResetTalents();
            player->LearnTalent(12298, 5);
            player->LearnTalent(12301, 2);
            player->LearnTalent(50685, 3);
            player->LearnTalent(29598, 2);
            player->LearnTalent(12797, 2);
            player->LearnTalent(12975, 1);
            player->LearnTalent(12308, 3);
            player->LearnTalent(12313, 2);
            player->LearnTalent(59088, 2);
            player->LearnTalent(12311, 2);
            player->LearnTalent(12809, 1);
            player->LearnTalent(16538, 5);
            player->LearnTalent(29787, 3);
            player->LearnTalent(29593, 2);
            player->LearnTalent(46945, 2);
            player->LearnTalent(29140, 3);
            player->LearnTalent(47294, 3);
            player->LearnTalent(20243, 1);
            player->LearnTalent(57499, 1);
            player->LearnTalent(46951, 3);
            player->LearnTalent(58872, 2);
            player->LearnTalent(46968, 1);
            player->LearnTalent(12320, 2);
            player->LearnTalent(61216, 3);
            player->LearnTalent(16462, 2);
            player->LearnTalent(12282, 3);
            player->LearnTalent(12300, 3);
            player->LearnTalent(12285, 2);
            player->LearnTalent(16493, 2);
            player->LearnTalent(12834, 3);
            // Protection Warrior
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_WARRIOR_GLYPH_OF_BLOCKING);
            //Minor
            player->SetGlyph(1, MINOR_WARRIOR_GLYPH_OF_BATTLE);
            //Minor
            player->SetGlyph(2, MINOR_WARRIOR_GLYPH_OF_BLOODRAGE);
            ...
            player->SetGlyph(4, MINOR_WARRIOR_GLYPH_OF_CHARGE);
            //Major
            player->SetGlyph(5, MAJOR_WARRIOR_GLYPH_OF_DEVASTATE);
            player->SendTalentsInfoData(false);
            break;
        case 4:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->ResetTalents();
            player->LearnTalent(20205, 4); /* be jaye 20216 entry spell va be jaye 4 tedadi ke gharare begire bara player eshtebah nazani shayad crash she*/
            player->LearnTalent(9456, 2);
            player->LearnTalent(20257, 4);
            player->LearnTalent(20237, 3);
            player->LearnTalent(20210, 5);
            player->LearnTalent(31821, 1);
            player->LearnTalent(20254, 3);
            player->LearnTalent(20216, 1);
            player->LearnTalent(20359, 3);
            player->LearnTalent(31822, 2);
            player->LearnTalent(5923, 5);
            player->LearnTalent(20473, 1);
            player->LearnTalent(31837, 4);
            player->LearnTalent(53551, 3);
            player->LearnTalent(53671, 4);
            player->LearnTalent(31842, 1);
            player->LearnTalent(53569, 2);
            player->LearnTalent(53556, 2);
            player->LearnTalent(53563, 1);
            player->LearnTalent(63646, 5);
            player->LearnTalent(20174, 2);
            player->LearnTalent(31844, 3);
            player->LearnTalent(12299, 1);
            player->LearnTalent(20468, 3);
            player->LearnTalent(64205, 1);
            player->LearnTalent(20487, 2);
            player->LearnTalent(53527, 2);
            // Holy
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PALADIN_GLYPH_OF_HOLY_SHOCK);
            //Minor
            player->SetGlyph(1, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_KINGS);
            //Minor
            player->SetGlyph(2, MINOR_PALADIN_GLYPH_OF_THE_WISE);
            //Major
            player->SetGlyph(3, MAJOR_PALADIN_GLYPH_OF_SEAL_OF_LIGHT);
            //Minor
            player->SetGlyph(4, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_WISDOM);
            //Major
            player->SetGlyph(5, MAJOR_PALADIN_GLYPH_OF_TURN_EVIL);
            player->SendTalentsInfoData(false);
            break;
        case 5:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->ResetTalents();
            player->LearnTalent(20262, 5);
            player->LearnTalent(20174, 2);
            player->LearnTalent(31844, 3);
            player->LearnTalent(12299, 1);
            player->LearnTalent(20468, 3);
            player->LearnTalent(64205, 1);
            player->LearnTalent(20138, 3);
            player->LearnTalent(20487, 2);
            player->LearnTalent(53527, 2);
            player->LearnTalent(20177, 4);
            player->LearnTalent(20911, 1);
            player->LearnTalent(20196, 3);
            player->LearnTalent(31850, 3);
            player->LearnTalent(20925, 1);
            player->LearnTalent(31785, 1);
            player->LearnTalent(31858, 3);
            player->LearnTalent(20127, 3);
            player->LearnTalent(53583, 2);
            player->LearnTalent(31935, 1);
            player->LearnTalent(53590, 3);
            player->LearnTalent(53695, 2);
            player->LearnTalent(53709, 3);
            player->LearnTalent(53595, 1);
            player->LearnTalent(20101, 5);
            player->LearnTalent(20335, 3);
            player->LearnTalent(25956, 2);
            player->LearnTalent(20117, 5);
            player->LearnTalent(31866, 3);
            // Protection
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PALADIN_GLYPH_OF_AVENGERS_SHIELD);
            //Minor
            player->SetGlyph(1, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_KINGS);
            //Minor
            player->SetGlyph(2, MINOR_PALADIN_GLYPH_OF_SENSE_UNDEAD);
            //Major
            player->SetGlyph(3, MAJOR_PALADIN_GLYPH_OF_JUDGEMENT);
            //Minor
            player->SetGlyph(4, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_WISDOM);
            //Major
            player->SetGlyph(5, MAJOR_PALADIN_GLYPH_OF_TURN_EVIL);
        ...
        case 6:
            ...
            player->ResetTalents();
            player->LearnTalent(20101, 5);
            player->LearnTalent(20042, 2);
            player->LearnTalent(20335, 2);
            player->LearnTalent(25956, 2);
            player->LearnTalent(20117, 5);
            player->LearnTalent(26022, 2);
            player->LearnTalent(9452, 1);
            player->LearnTalent(31868, 3);
            player->LearnTalent(32043, 3);
            player->LearnTalent(31868, 1);
            player->LearnTalent(12163, 3);
            player->LearnTalent(31871, 2);
            player->LearnTalent(20049, 3);
            player->LearnTalent(20066, 1);
            player->LearnTalent(31876, 3);
            player->LearnTalent(53486, 2);
            player->LearnTalent(31879, 3);
            player->LearnTalent(53375, 2);
            player->LearnTalent(53501, 3);
            player->LearnTalent(35395, 1);
            player->LearnTalent(53380, 3);
            player->LearnTalent(53385, 1);
            player->LearnTalent(20262, 5);
            player->LearnTalent(20174, 2);
            player->LearnTalent(64205, 1);
            player->LearnTalent(20224, 5);
            player->LearnTalent(9453, 2);
            // Retribution
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PALADIN_GLYPH_OF_JUDGEMENT);
            //Minor
            player->SetGlyph(1, MINOR_PALADIN_GLYPH_OF_SENSE_UNDEAD);
            //Minor
            player->SetGlyph(2, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_KINGS);
            //Major
            player->SetGlyph(3, MAJOR_PALADIN_GLYPH_OF_SEAL_OF_RIGHTEOUSNESS);
            //Minor
            player->SetGlyph(4, MINOR_PALADIN_GLYPH_OF_BLESSING_OF_WISDOM);
            //Major
            player->SetGlyph(5, MAJOR_PALADIN_GLYPH_OF_TURN_EVIL);
        ...
        case 7:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_HUNTER_GLYPH_OF_AIMED_SHOT);
            //Minor
            player->SetGlyph(1, MINOR_HUNTER_GLYPH_OF_REVIVE_PET);
            //Minor
            player->SetGlyph(2, MINOR_HUNTER_GLYPH_OF_SCARE_BEAST);
            //Major
            player->SetGlyph(3, MAJOR_HUNTER_GLYPH_OF_DISENGAGE);
            //Minor
            player->SetGlyph(4, MINOR_HUNTER_GLYPH_OF_FEIGN_DEATH);
            //Major
            player->SetGlyph(5, MAJOR_HUNTER_GLYPH_OF_BESTIAL_WRATH);
            player->SendTalentsInfoData(false);
            break;
        case 8:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->SetGlyph(4, MINOR_HUNTER_GLYPH_OF_FEIGN_DEATH);
            //Major
            player->SetGlyph(5, MAJOR_HUNTER_GLYPH_OF_SERPENT_STING);
            player->SendTalentsInfoData(false);
            break;
        case 9:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_HUNTER_GLYPH_OF_EXPLOSIVE_TRAP);
            //Minor
            player->SetGlyph(1, MINOR_HUNTER_GLYPH_OF_REVIVE_PET);
            //Minor
            player->SetGlyph(2, MINOR_HUNTER_GLYPH_OF_SCARE_BEAST);
            ...
            player->SetGlyph(4, MINOR_HUNTER_GLYPH_OF_FEIGN_DEATH);
            //Major
            player->SetGlyph(5, MAJOR_HUNTER_GLYPH_OF_WYVERN_STING);
            player->SendTalentsInfoData(false);
            break;
        case 10:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_ROGUE_GLYPH_OF_SPRINT);
            //Minor
            player->SetGlyph(1, MINOR_ROGUE_GLYPH_OF_VANISH);
            //Minor
            player->SetGlyph(2, MINOR_ROGUE_GLYPH_OF_DISTRACT);
            //Major
            player->SetGlyph(3, MAJOR_ROGUE_GLYPH_OF_MUTILATE);
            //Minor
            player->SetGlyph(4, MINOR_ROGUE_GLYPH_OF_SAFE_FALL);
            //Major
            player->SetGlyph(5, MAJOR_ROGUE_GLYPH_OF_PREPARATION);
            player->SendTalentsInfoData(false);
            break;
        case 11:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_ROGUE_GLYPH_OF_KILLING_SPREE);
            //Minor
            player->SetGlyph(1, MINOR_ROGUE_GLYPH_OF_VANISH);
            //Minor
            player->SetGlyph(2, MINOR_ROGUE_GLYPH_OF_DISTRACT);
            //Major
            player->SetGlyph(3, MAJOR_ROGUE_GLYPH_OF_ADRENALINE_RUSH);
            //Minor
            player->SetGlyph(4, MINOR_ROGUE_GLYPH_OF_BLURRED_SPEED);
            //Major
            player->SetGlyph(5, MAJOR_ROGUE_GLYPH_OF_SINISTER_STRIKE);
            player->SendTalentsInfoData(false);
            break;
        case 12:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->SetGlyph(2, MINOR_ROGUE_GLYPH_OF_DISTRACT);
            //Major
            player->SetGlyph(3, MAJOR_ROGUE_GLYPH_OF_SHADOW_DANCE);
            //Minor
            player->SetGlyph(4, MINOR_ROGUE_GLYPH_OF_SAFE_FALL);
            //Major
            player->SetGlyph(5, MAJOR_ROGUE_GLYPH_OF_PREPARATION);
        ...
        case 13:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PRIEST_GLYPH_OF_POWER_WORD_SHIELD);
            //Minor
            player->SetGlyph(1, MINOR_PRIEST_GLYPH_OF_LEVITATE);
            //Minor
            player->SetGlyph(2, MINOR_PRIEST_GLYPH_OF_FORTITUDE);
            //Major
            player->SetGlyph(3, MAJOR_PRIEST_GLYPH_OF_PAIN_SUPPRESSION);
            //Minor
            player->SetGlyph(4, MINOR_PRIEST_GLYPH_OF_SHACKLE_UNDEAD);
            //Major
            player->SetGlyph(5, MAJOR_PRIEST_GLYPH_OF_PENANCE);
            player->SendTalentsInfoData(false);
            break;
        case 14:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PRIEST_GLYPH_OF_GUARDIAN_SPIRIT);
            //Minor
            player->SetGlyph(1, MINOR_PRIEST_GLYPH_OF_LEVITATE);
            //Minor
            player->SetGlyph(2, MINOR_PRIEST_GLYPH_OF_FORTITUDE);
            //Major
            player->SetGlyph(3, MAJOR_PRIEST_GLYPH_OF_LIGHTWELL);
            //Minor
            player->SetGlyph(4, MINOR_PRIEST_GLYPH_OF_SHACKLE_UNDEAD);
            //Major
            player->SetGlyph(5, MAJOR_PRIEST_GLYPH_OF_SMITE);
            player->SendTalentsInfoData(false);
            break;
        case 15:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_PRIEST_GLYPH_OF_DISPERSION);
            //Minor
            player->SetGlyph(1, MINOR_PRIEST_GLYPH_OF_LEVITATE);
            //Minor
            player->SetGlyph(2, MINOR_PRIEST_GLYPH_OF_FORTITUDE);
            //Major
            player->SetGlyph(3, MAJOR_PRIEST_GLYPH_OF_FADE);
            //Minor
            player->SetGlyph(4, MINOR_PRIEST_GLYPH_OF_FADING);
            //Major
            player->SetGlyph(5, MAJOR_PRIEST_GLYPH_OF_INNER_FIRE);
            player->SendTalentsInfoData(false);
            break;
        case 16:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DEATHKNIGHT_GLYPH_OF_DARK_DEATH);
            //Minor
            player->SetGlyph(1, MINOR_DEATHKNIGHT_GLYPH_OF_RAISE_DEAD);
            //Minor
            player->SetGlyph(2, MINOR_DEATHKNIGHT_GLYPH_OF_HORN_OF_WINTER);
            //Major
            player->SetGlyph(3, MAJOR_DEATHKNIGHT_GLYPH_OF_RUNE_STRIKE);
            //Minor
            player->SetGlyph(4, MINOR_DEATHKNIGHT_GLYPH_OF_BLOOD_TAP);
            //Major
            player->SetGlyph(5, MAJOR_DEATHKNIGHT_GLYPH_OF_HEART_STRIKE);
            player->SendTalentsInfoData(false);
            break;
        case 17:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DEATHKNIGHT_GLYPH_OF_FROST_STRIKE);
            //Minor
            player->SetGlyph(1, MINOR_DEATHKNIGHT_GLYPH_OF_RAISE_DEAD);
            //Minor
            player->SetGlyph(2, MINOR_DEATHKNIGHT_GLYPH_OF_HORN_OF_WINTER);
            //Major
            player->SetGlyph(3, MAJOR_DEATHKNIGHT_GLYPH_OF_ANTIMAGIC_SHELL);
            //Minor
            player->SetGlyph(4, MINOR_DEATHKNIGHT_GLYPH_OF_DEATHS_EMBRACE);
            //Major
            player->SetGlyph(5, MAJOR_DEATHKNIGHT_GLYPH_OF_HUNGERING_COLD);
            player->SendTalentsInfoData(false);
            break;
        case 18:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DEATHKNIGHT_GLYPH_OF_THE_GHOUL);
            //Minor
            player->SetGlyph(1, MINOR_DEATHKNIGHT_GLYPH_OF_RAISE_DEAD);
            //Minor
            player->SetGlyph(2, MINOR_DEATHKNIGHT_GLYPH_OF_HORN_OF_WINTER);
            //Major
            player->SetGlyph(3, MAJOR_DEATHKNIGHT_GLYPH_OF_PLAGUE_STRIKE);
            //Minor
            player->SetGlyph(4, MINOR_DEATHKNIGHT_GLYPH_OF_DEATHS_EMBRACE);
            //Major
            player->SetGlyph(5, MAJOR_DEATHKNIGHT_GLYPH_OF_ICY_TOUCH);
            player->SendTalentsInfoData(false);
            break;
        case 19:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_SHAMAN_GLYPH_OF_THUNDER);
            //Minor
            player->SetGlyph(1, MINOR_SHAMAN_GLYPH_OF_GHOST_WOLF);
            //Minor
            player->SetGlyph(2, MINOR_SHAMAN_GLYPH_OF_WATER_SHIELD);
            //Major
            player->SetGlyph(3, MAJOR_SHAMAN_GLYPH_OF_STONECLAW_TOTEM);
            //Minor
            player->SetGlyph(4, MINOR_SHAMAN_GLYPH_OF_WATER_WALKING);
            //Major
            player->SetGlyph(5, MAJOR_SHAMAN_GLYPH_OF_LAVA);
            player->SendTalentsInfoData(false);
            break;
        case 20:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_SHAMAN_GLYPH_OF_SHOCKING);
            //Minor
            player->SetGlyph(1, MINOR_SHAMAN_GLYPH_OF_GHOST_WOLF);
            //Minor
            player->SetGlyph(2, MINOR_SHAMAN_GLYPH_OF_WATER_SHIELD);
            ...
            player->SetGlyph(4, MINOR_SHAMAN_GLYPH_OF_WATER_WALKING);
            //Major
            player->SetGlyph(5, MAJOR_SHAMAN_GLYPH_OF_FERAL_SPIRIT);
            player->SendTalentsInfoData(false);
            break;
        case 21:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_SHAMAN_GLYPH_OF_EARTH_SHIELD);
            //Minor
            player->SetGlyph(1, MINOR_SHAMAN_GLYPH_OF_GHOST_WOLF);
            //Minor
            player->SetGlyph(2, MINOR_SHAMAN_GLYPH_OF_WATER_SHIELD);
            ...
            player->SetGlyph(4, MINOR_SHAMAN_GLYPH_OF_WATER_WALKING);
            //Major
            player->SetGlyph(5, MAJOR_SHAMAN_GLYPH_OF_LESSER_HEALING_WAVE);
            player->SendTalentsInfoData(false);
            break;
        case 22:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_MAGE_GLYPH_OF_ARCANE_MISSILES);
            //Minor
            player->SetGlyph(1, MINOR_MAGE_GLYPH_OF_FIRE_WARD);
            //Minor
            player->SetGlyph(2, MINOR_MAGE_GLYPH_OF_FROST_WARD);
            //Major
            player->SetGlyph(3, MAJOR_MAGE_GLYPH_OF_EVOCATION);
            //Minor
            player->SetGlyph(4, MINOR_MAGE_GLYPH_OF_SLOW_FALL);
            //Major
            player->SetGlyph(5, MAJOR_MAGE_GLYPH_OF_POLYMORPH);
            player->SendTalentsInfoData(false);
            break;
        case 23:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_MAGE_GLYPH_OF_LIVING_BOMB);
            //Minor
            player->SetGlyph(1, MINOR_MAGE_GLYPH_OF_FIRE_WARD);
            //Minor
            player->SetGlyph(2, MINOR_MAGE_GLYPH_OF_FROST_WARD);
        ...
        case 24:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_MAGE_GLYPH_OF_ICE_BARRIER);
            //Minor
            player->SetGlyph(1, MINOR_MAGE_GLYPH_OF_FIRE_WARD);
            //Minor
            player->SetGlyph(2, MINOR_MAGE_GLYPH_OF_FROST_WARD);
        ...
        case 25:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_WARLOCK_GLYPH_OF_CORRUPTION);
            //Minor
            player->SetGlyph(1, MINOR_WARLOCK_GLYPH_OF_CURSE_OF_EXHAUSION);
            //Minor
            player->SetGlyph(2, MINOR_WARLOCK_GLYPH_OF_DRAIN_SOUL);
            //Major
            player->SetGlyph(3, MAJOR_WARLOCK_GLYPH_OF_SHADOWFLAME);
            //Minor
            player->SetGlyph(4, MINOR_WARLOCK_GLYPH_OF_SOULS);
            //Major
            player->SetGlyph(5, MAJOR_WARLOCK_GLYPH_OF_QUICK_DECAY);
            player->SendTalentsInfoData(false);
            break;
        case 26:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->SetGlyph(2, MINOR_WARLOCK_GLYPH_OF_DRAIN_SOUL);
            //Major
            player->SetGlyph(3, MAJOR_WARLOCK_GLYPH_OF_METAMORPHOSIS);
            //Minor
            player->SetGlyph(4, MINOR_WARLOCK_GLYPH_OF_SOULS);
            //Major
            player->SetGlyph(5, MAJOR_WARLOCK_GLYPH_OF_LIFE_TAP);
            player->SendTalentsInfoData(false);
            break;
        case 27:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_WARLOCK_GLYPH_OF_CONFLAGRATE);
            //Minor
            player->SetGlyph(1, MINOR_WARLOCK_GLYPH_OF_CURSE_OF_EXHAUSION);
            //Minor
            player->SetGlyph(2, MINOR_WARLOCK_GLYPH_OF_DRAIN_SOUL);
            ...
            player->SetGlyph(4, MINOR_WARLOCK_GLYPH_OF_SOULS);
            //Major
            player->SetGlyph(5, MAJOR_WARLOCK_GLYPH_OF_IMMOLATE);
            player->SendTalentsInfoData(false);
            break;
        case 28:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DRUID_GLYPH_OF_STARFALL);
            //Minor
            player->SetGlyph(1, MINOR_DRUID_GLYPH_OF_DASH);
            //Minor
            player->SetGlyph(2, MINOR_DRUID_GLYPH_OF_THE_WILD);
            //Major
            player->SetGlyph(3, MAJOR_DRUID_GLYPH_OF_INSECT_SWARM);
            //Minor
            player->SetGlyph(4, MINOR_DRUID_GLYPH_OF_THORNS);
            //Major
            player->SetGlyph(5, MAJOR_DRUID_GLYPH_OF_BARKSKIN);
            player->SendTalentsInfoData(false);
            break;
        case 29:
            player->EquipNewItem(EQUIPMENT_SLOT_HEAD, 0, true);
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DRUID_GLYPH_OF_SWIFTMEND);
            //Minor
            player->SetGlyph(1, MINOR_DRUID_GLYPH_OF_DASH);
            //Minor
            player->SetGlyph(2, MINOR_DRUID_GLYPH_OF_THE_WILD);
            //Major
            player->SetGlyph(3, MAJOR_DRUID_GLYPH_OF_INNERVATE);
            //Minor
            player->SetGlyph(4, MINOR_DRUID_GLYPH_OF_THORNS);
            //Major
            player->SetGlyph(5, MAJOR_DRUID_GLYPH_OF_BARKSKIN);
        ...
        case 30:
            ...
            player->CLOSE_GOSSIP_MENU();
            //Major
            player->SetGlyph(0, MAJOR_DRUID_GLYPH_OF_RIP);
            //Minor
            player->SetGlyph(1, MINOR_DRUID_GLYPH_OF_DASH);
            //Minor
            player->SetGlyph(2, MINOR_DRUID_GLYPH_OF_THE_WILD);
            //Major
            player->SetGlyph(3, MAJOR_DRUID_GLYPH_OF_SHRED);
            //Minor
            player->SetGlyph(4, MINOR_DRUID_GLYPH_OF_THORNS);
            //Major
            player->SetGlyph(5, MAJOR_DRUID_GLYPH_OF_BERSERK);
            player->SendTalentsInfoData(false);
            break;
        }
        player->CLOSE_GOSSIP_MENU();
