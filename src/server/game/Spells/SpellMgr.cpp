...
void SpellMgr::LoadSpellInfoCorrections()
{
	...
	for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
	{
		...
		case 5171: // Slice and Dice (Might not work)
		...
		case 37015:
			...
			spellInfo->Effects[EFFECT_0].MiscValue = 21510; // mount NPC entry
			spellInfo->Effects[EFFECT_1].BasePoints = 1 - 1; // flight speed
			spellInfo->Effects[EFFECT_2].BasePoints = 1 - 1; // ground speed
			break;
